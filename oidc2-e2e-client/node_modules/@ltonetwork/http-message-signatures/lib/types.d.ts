...
export type Component = '@method' | '@target-uri' | '@authority' | '@scheme' | '@request-target' | '@path' | '@query' | '@query-params' | '@status' | '@request-response' | string;
...
export type Parameters = StandardParameters & {
    [name: Parameter]: string | number | true | Date | {
...
export type SignOptions = StandardParameters & {
    ...
    [name: Parameter]: Component[] | Signer | LTOAccount | string | number | true | Date | {
        [Symbol.toStringTag]: () => string;
    };
};
export {};
